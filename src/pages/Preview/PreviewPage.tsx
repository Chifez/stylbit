...
const PreviewPage = (props: { products: DocumentData; toggle: () => void }) => {
				...
				<div className="md:col-span-2 py-5 md:py-20">
					...
					<div className="flex items-center gap-1 py-2">
						...
						<RoundButton
							...
							extraclasses="hover:text-white hover:bg-transparent font-Hmid border uppercase py-1 px-3 rounded-none"
							onClick={AddToCart}
						/>
					</div>
				</div>
