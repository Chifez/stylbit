...
const ShippingDetailsForm = () => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center h-screen">
      <AuthNavBar />
      <form className="flex flex-col gap-5 p-5 md:p-10 shadow-xl w-full md:w-[70%] xl:w-[40%]">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-2 w-full">
          <InputForm
            ...
            className="p-1 py-2 w-full rounded-sm bg-transparent"
          ...
          <div className="flex flex-row items-center w-full md:w-[60%] ">
            <SelectInput
              Options={phonecode}
              initialstate="234"
              extraclass="p-1 py-2 w-[4rem]  border-secondary border-r-transparent"
            />
            <InputForm
              label="phone number"
              type="text"
              ...
              className="p-1 py-2 rounded-sm bg-transparent border-transparent"
              inputChange={(e) => handleChange(e)}
            />
          </div>
        </div>
        <div className="flex gap-2 w-full ">
          <SelectInput
            Options={state}
            initialstate="Lagos"
            extraclass="p-1 py-2 max-w-[6rem] md:w-[7rem] border-secondary"
          />
          <InputForm
            label="city"
            type="text"
            ...
            value={city}
            placeholder="city"
            className="p-1 py-2 rounded-sm bg-transparent"
            inputChange={(e) => handleChange(e)}
          />
        </div>
        <div className="flex gap-2 w-full">
          <InputForm
            ...
            value={address}
            placeholder="Address"
            className="p-1 py-2 max-w-[12rem] md:w-[20rem] rounded-sm bg-transparent"
            inputChange={(e) => handleChange(e)}
          />
          <InputForm
            label="zip code"
