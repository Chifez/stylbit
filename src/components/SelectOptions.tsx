    ...
    <div>
      ...
      >
        <div
          ...
          className={`flex items-center justify-between bg-transparent border rounded-md ${props.extraclass}`}
        >
        ...
        <div
          className={`${
            open ? "block" : "hidden"
          } w-full border absolute bg-primary cursor-pointer rounded-md z-20`}
        >
